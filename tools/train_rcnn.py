...
parser.add_argument('--data_path', type = str, default = None, help = 'specify an output directory if needed')
...
def create_dataloader(logger, data_path):
    DATA_PATH = os.path.join(data_path)  #os.path.join('../', 'data')
...
if __name__ == "__main__":
    ...
    train_loader, test_loader = create_dataloader(logger, data_path=args.data_path)
